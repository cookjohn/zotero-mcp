...
export type FluentMessageId =
  ...
  | 'pref-output-mode-full'
  | 'pref-output-mode-label'
  | 'pref-output-mode-minimal'
  | 'pref-output-mode-preview'
  | 'pref-output-mode-smart'
  | 'pref-preset-balanced'
  | 'pref-preset-comprehensive'
  | 'pref-preset-conservative'
  | 'pref-preset-custom'
  | 'pref-preset-mode-label'
  | 'pref-preset-performance'
