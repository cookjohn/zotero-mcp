...
pref-mcp-settings-title = MCP Processing Settings
...
pref-preset-mode-label = Processing Mode:
pref-preset-conservative = Conservative (Minimal)
pref-preset-balanced = Balanced (Default)
pref-preset-comprehensive = Comprehensive (No Limits)
pref-preset-performance = Performance (Fast)
pref-preset-custom = Custom (Manual)
pref-custom-settings-title = Custom Settings
pref-output-mode-label = Output Mode:
pref-output-mode-smart = Smart (Auto-adjust)
pref-output-mode-preview = Preview (Limited)
pref-output-mode-full = Full Content
pref-output-mode-minimal = Minimal
