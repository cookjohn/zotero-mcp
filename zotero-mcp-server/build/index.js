...
async function makeZoteroRequest(endpoint, params = {}) {
...
async function main() {
    ...
    server.tool("search", "Performs a general search of the Zotero library. For each item found, it returns a set of basic bibliographic data, including `key`, `title`, `itemType`, `date`, and `creators`.", searchSchema, async (params) => {
        try {
