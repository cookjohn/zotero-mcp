...
async function main() {
  ...
  server.tool(
    "search",
    "Performs a search of the Zotero library with multiple criteria. It can search by keywords, title, item key, and tags. For each item found, it returns basic bibliographic data, including `key`, `title`, `itemType`, `date`, and `creators`.",
    searchSchema,
    async (params: any) => {
      try {
